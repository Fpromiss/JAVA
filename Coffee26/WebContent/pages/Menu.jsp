		...
		<div>
			<div class="menu" align="center">
				<div style="display: flex; justify-content: space-around;">
					<div class="search-form-div" align="center" style="color: white; font-size: 18px;">
					...
					<div>
						<button id="shoppingCart" class="btn" type="button"
							onclick="document.location='shop.jsp';">购物车</button>
					</div>
				</div>
				<div class="menu-content" style="width: 80%;">
					...
					<div class="menu-content-item"
						...
						<div>
							...
							<form method="post" action="order/deleteorder.jsp">
								<input type="hidden" name="i" size="20" value=<%=i%> /> <input
									type="submit" value="-"></input>
							</form>
							<form method="post" action="order/addorder.jsp">
								<input type="hidden" name="i" size="20" value=<%=i%> /> <input
									type="submit" value="+"></input>
							</form>
						</div>
