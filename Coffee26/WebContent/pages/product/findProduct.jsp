	 ...
	 <caption style="text-align:left;font-size:31px;">查询到的餐品信息：</caption>
	  <tr>
	   ...
	   <form name="return" method="post" action="../ManagementOfMenu.jsp" >
	    <input type="submit" value="返回" style="margin:0 0 0 5px;border-style:1px;width:55px;height:36px;background-repeat:no-repeat;font-family:'FZQingKeBenYueSongS-R-GB';font-size:25px;color:black;"/>
	    </form>
