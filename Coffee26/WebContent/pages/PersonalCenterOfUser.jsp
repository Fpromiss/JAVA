...
<body>
	...
	<div class="greeting">
		<p>
			你好，<span style="color: #da171d;"><%=n.getName()%></span>！
		</p>
	</div>

	<div class="using-options">
		<div class="content">
			<div class="content1" onclick="window.location.href='#personalInfo';">
				<p>个人信息</p>
			</div>
			<div class="content2" onclick="window.location.href='#myVIP';">
				<p>我的VIP</p>
			</div>
			<div class="content3" onclick="window.location.href='#shoppingCart';">
				<p>购物车</p>
			</div>
			<div class="content4"
				onclick="window.location.href='#historyOrderDetails';">
				<p>历史订单</p>
			</div>
		</div>
		<br /> <br /> <br />
			...
			<div>
				...
				<div class="content"
					...
					<form class="personal-info-form" id="edit-info-form" method="POST"
						...
						onSubmit="return confirmInfo(this);">
					...
					<form class="account-pwd-form" id="edit-pwd-form" method="POST"
						...
						<table class="edit-pwd-table" id="edit-pwd-table">
							<tr>
								<td>原密码：</td>
	...
	<div id="myVIP">
		<div class="myVIP">
			...
			<div class="content">
				...
				<div class="content2" onclick="">
					<p>我的会员</p>
				</div>
			</div>
			<div class="buttons" align="right" style="margin-right: 100px;">
				<button type="button" class="btn" onclick="">详情</button>
			</div>
			<br />
		</div>
	</div>
		...
		<div class="shoppingCart">
			...
			<div class="buttons" align="right" style="margin-right: 100px;">
				<button type="button" class="btn"
					onclick="document.location='shop.jsp';">详情</button>
			</div>
			<br />
		</div>
	</div>

	<div id="historyOrderDetails">
		<div class="historyOrderDetails">
			<br /> <br /> <br />
			<p>历史订单</p>
			<hr />
			<div class="buttons" align="right" style="margin-right: 100px;">
				<button type="button" class="btn"
					onclick="document.location='order/history.jsp';">详情</button>
			</div>
			<br />
		</div>
		<br /> <br /> <br /> <br /> <br />
